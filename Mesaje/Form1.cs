...
namespace TaskbarNotifierDemo
{
	...
	public class Form1 : Form
	{
		...
		public Form1()
		{
            ...
            taskbarNotifier1.SetCloseBitmap((Bitmap)rm.GetObject("close"), Color.FromArgb(255, 0, 255), new Point(127, 8));
            ...
            taskbarNotifier2.SetBackgroundBitmap((Bitmap)rm.GetObject("skin2"), Color.FromArgb(255, 0, 255));
            taskbarNotifier2.SetCloseBitmap((Bitmap)rm.GetObject("close2"), Color.FromArgb(255, 0, 255), new Point(300, 74));
            ...
            taskbarNotifier3.SetBackgroundBitmap((Bitmap)rm.GetObject("skin3"), Color.FromArgb(255, 0, 255));
            taskbarNotifier3.SetCloseBitmap((Bitmap)rm.GetObject("close"), Color.FromArgb(255, 0, 255), new Point(280, 57));
